...
public class TestLimitedSep {

    public static void main(String[] args) {
//        System.out.println(JSON.toJSON(new TestLimitedSep().sss("bid_volume2")));
        new TestLimitedSep().testSeparateOrderByMarketPrice();
    }
...
//        String s = json.replaceAll("\"", "\"").replaceAll("\n", "");
    ...
    public MainDelegation getMainOrder() {
        ...
        main.setAmount(new BigDecimal(400));
        main.setPrice(new BigDecimal("0.001447"));
