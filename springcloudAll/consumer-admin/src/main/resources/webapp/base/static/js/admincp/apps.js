...
var handleDraggablePanel = function() {
    ...
    var t = ".panel-heading";
    var n = ".row > [class*=col]";
    $.each(e , function(index , curr){
        var a = $(curr) ,
            isDrag = a.find(".panel:first").attr("data-no-drag");
        if(isDrag) return ;
        a.sortable({
            handle: t,
            connectWith: n,
...
var handleThemePageStructureControl = function() {
    ...
    $(".theme-list [data-theme]").on("click",
    function() {
    ...
    $(".theme-panel [name=content-styling]").on("change",
    function() {
        if ($(this).val() == 2) {
            $("body").addClass("flat-black");
    ...
    $(".theme-panel [name=sidebar-fixed]").on("change",
    function() {
        if ($(this).val() == 1) {
    ...
    $(".theme-panel [name=header-fixed]").on("change",
    function() {
        if ($(this).val() == 1) {
            $("#header").addClass("navbar-fixed-top");
            $("#page-container").addClass("page-header-fixed");
...
var handleThemePanelExpand = function() {
    $('[data-click="theme-panel-expand"]').on("click",
    function() {
        var e = ".theme-panel";
        var t = "active";
        if ($(e).hasClass(t)) {
...
var handleResetLocalStorage = function() {
    ...
    $("[data-click=reset-local-storage]").on("click", function(e) {
        ...
        $("[data-click=confirm-reset-local-storage]").on("click",
            function(e) {
                e.preventDefault();
