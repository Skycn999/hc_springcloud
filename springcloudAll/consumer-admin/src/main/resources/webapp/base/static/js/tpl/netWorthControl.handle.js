...
var dtGridOption = {
    lang: 'zh-cn',
    ajaxLoad: true,
    loadURL: ncGlobal.adminRoot + '/netWorthControl/json/list',
    // exportURL: ncGlobal.adminRoot + 'userIdentify/json/export',
    exportFileName: '净值风控模板表',
    columns: dtGridColumns,
    gridContainer: 'dtGridContainer',
    toolbarContainer: 'dtGridToolBarContainer',
    pageSize: 10,
    pageSizeLimit: [10, 20, 50],
    ncColumnsType: {int:["id","delFlag","state","isDefault"],Timestamp:["createTime","updateTime"]}
};
...
var OperateHandle = function () {
    ...
    function _bindEvent() {
        ...
        $("#addModal").on("show.bs.modal", function (event) {
            ...
            $("#addForm").find("[name='allowMinAmount']").val("");
        ...
        $('#editModal').on('show.bs.modal', function (event) {
            ...
            modal.find('input[name="allowMinAmount"]').val(gridData.allowMinAmount);
