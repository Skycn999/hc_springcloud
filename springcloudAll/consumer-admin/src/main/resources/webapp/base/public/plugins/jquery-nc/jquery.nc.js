...
(function($) {
    ...
    Cart.setting = {
        ...
        tpl: {
            ...
            goodsItem: '<dl>'
            + '<dt class="goods-name">'
            + '<a href="' + ncGlobal.webRoot + 'goods/<%=commonId%>" title="<%=goodsName%> <%=goodsFullSpecs%>"><%=goodsName%><p><%=goodsFullSpecs%></p></a>'
            + '</dt>'
            + '<dd class="goods-thumb">'
            + '<a href="' + ncGlobal.webRoot + 'goods/<%=commonId%>" title="<%=goodsName%> <%=goodsFullSpecs%>">'
            + '<img src="<%=imageSrc%>"></a>'
            + '</dd>'
